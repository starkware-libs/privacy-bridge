...
export default defineConfig({
  ...
  test: {
    ...
    env: {
      ...
      // CCTP contracts, STRK + native USDC) are BAKED-ONLY in bridge-core config.ts — NOT
      // env-injectable — so no fixture is set for them here (they read the baked defaults).
