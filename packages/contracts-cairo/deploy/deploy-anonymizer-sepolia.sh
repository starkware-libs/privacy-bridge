#!/usr/bin/env bash
# Declare + deploy the Anonymizer to Starknet SEPOLIA (testnet).
#
...
#      SN requires Sierra 1.8.0 — older scarb emits 1.7.0 and is rejected):
...
echo "Anonymizer sepolia deploy"
